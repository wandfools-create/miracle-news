...
const labels = {
  ...
  latestTitle: "방금 올라온 기사",
  categoriesEyebrow: "Sections",
  categoriesTitle: "카테고리별 뉴스",
  categoryCount: (n: number) => `${n}건`,
...
function toKoreanCard(article: HomeArticleCard) {
  return article;
}

export default function KoreanEditionView({ sections, errorMessage }: Props) {
  const hasArticles =
